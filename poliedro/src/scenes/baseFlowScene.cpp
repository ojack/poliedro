...
void baseFlowScene::updateFlow(){
   ...
   // simpleCam.update();
    ...
    if (IM->bIsFrameNew) {
        ...
        if (doFlipCamera)
            IM->medianFilteredResult.draw(cameraFbo.getWidth(), 0, -cameraFbo.getWidth(), cameraFbo.getHeight());  // Flip Horizontal
        else
            IM->medianFilteredResult.draw(0, 0, cameraFbo.getWidth(), cameraFbo.getHeight());
        cameraFbo.end();
        ofPopStyle();
      ...
      //  velocityMask.setDensity(cameraFbo.getTexture());
       // velocityMask.setDensity(image1->getTexture());
      //  setVelocityMask(image1->getTexture());
...
void baseFlowScene::setVelocityMask(ofTexture & tex){
    velocityMask.setDensity(tex);
  //   velocityMask.update();
}
//--------------------------------------------------------------
void baseFlowScene::keyPressed(int key){
    switch (key) {
        case 'G':
...
//--------------------------------------------------------------
void baseFlowScene::drawModeSetName(int &_value) {
    switch(_value) {
...
void baseFlowScene::setupGui() {
  ...
  //  doFullScreen.addListener(this, &baseFlowScene::setFullScreen);
    ...
    drawMode.addListener(this, &baseFlowScene::drawModeSetName);
    ...
    displayScalarScale.addListener(this, &baseFlowScene::setDisplayScalarScale);
    visualizeParameters.add(velocityFieldScale.set("velocity scale", 0.1, 0.0, 0.5));
    velocityFieldScale.addListener(this, &baseFlowScene::setVelocityFieldScale);
    visualizeParameters.add(temperatureFieldScale.set("temperature scale", 0.1, 0.0, 0.5));
    temperatureFieldScale.addListener(this, &baseFlowScene::setTemperatureFieldScale);
    visualizeParameters.add(pressureFieldScale.set("pressure scale", 0.02, 0.0, 0.5));
    pressureFieldScale.addListener(this, &baseFlowScene::setPressureFieldScale);
    visualizeParameters.add(velocityLineSmooth.set("line smooth", false));
    velocityLineSmooth.addListener(this, &baseFlowScene::setVelocityLineSmooth);
...
void baseFlowScene::drawComposite(int _x, int _y, int _width, int _height) {
    ofPushStyle();
...
//--------------------------------------------------------------
void baseFlowScene::drawParticles(int _x, int _y, int _width, int _height) {
    ofPushStyle();
...
//--------------------------------------------------------------
void baseFlowScene::drawFluidFields(int _x, int _y, int _width, int _height) {
    ofPushStyle();
...
//--------------------------------------------------------------
void baseFlowScene::drawFluidDensity(int _x, int _y, int _width, int _height) {
    ofPushStyle();
...
//--------------------------------------------------------------
void baseFlowScene::drawFluidVelocity(int _x, int _y, int _width, int _height) {
    ofPushStyle();
    if (showScalar.get()) {
        ofClear(0,0);
        ofEnableBlendMode(OF_BLENDMODE_ALPHA);
...
//--------------------------------------------------------------
void baseFlowScene::drawFluidPressure(int _x, int _y, int _width, int _height) {
    ofPushStyle();
    ofClear(128);
    if (showScalar.get()) {
        ofEnableBlendMode(OF_BLENDMODE_DISABLED);
...
//--------------------------------------------------------------
void baseFlowScene::drawFluidTemperature(int _x, int _y, int _width, int _height) {
    ofPushStyle();
    if (showScalar.get()) {
        ofEnableBlendMode(OF_BLENDMODE_DISABLED);
...
//--------------------------------------------------------------
void baseFlowScene::drawFluidDivergence(int _x, int _y, int _width, int _height) {
    ofPushStyle();
    if (showScalar.get()) {
        ofEnableBlendMode(OF_BLENDMODE_DISABLED);
...
//--------------------------------------------------------------
void baseFlowScene::drawFluidVorticity(int _x, int _y, int _width, int _height) {
    ofPushStyle();
    if (showScalar.get()) {
        ofEnableBlendMode(OF_BLENDMODE_DISABLED);
...
//--------------------------------------------------------------
void baseFlowScene::drawFluidBuoyance(int _x, int _y, int _width, int _height) {
    ofPushStyle();
    if (showScalar.get()) {
        ofEnableBlendMode(OF_BLENDMODE_DISABLED);
...
//--------------------------------------------------------------
void baseFlowScene::drawFluidObstacle(int _x, int _y, int _width, int _height) {
    ofPushStyle();
    ofEnableBlendMode(OF_BLENDMODE_DISABLED);
...
//--------------------------------------------------------------
void baseFlowScene::drawMask(int _x, int _y, int _width, int _height) {
    ofPushStyle();
    ofEnableBlendMode(OF_BLENDMODE_DISABLED);
...
//--------------------------------------------------------------
void baseFlowScene::drawOpticalFlow(int _x, int _y, int _width, int _height) {
    ofPushStyle();
    if (showScalar.get()) {
        ofEnableBlendMode(OF_BLENDMODE_ALPHA);
...
//--------------------------------------------------------------
void baseFlowScene::drawSource(int _x, int _y, int _width, int _height) {
    ofPushStyle();
    ofEnableBlendMode(OF_BLENDMODE_DISABLED);
...
//--------------------------------------------------------------
void baseFlowScene::drawMouseForces(int _x, int _y, int _width, int _height) {
    ofPushStyle();
    ofClear(0,0);
...
//--------------------------------------------------------------
void baseFlowScene::drawVelocityDots(int _x, int _y, int _width, int _height) {
    ofPushStyle();
    ofEnableBlendMode(OF_BLENDMODE_ADD);
